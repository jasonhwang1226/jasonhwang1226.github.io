...
#define _dc         LATAbits.LATA3
#define TRIS_dc     TRISAbits.TRISA3
#define _dc_high()  {LATASET = 8;}
#define _dc_low()   {LATACLR = 8;}

#define _cs         LATBbits.LATB4
#define TRIS_cs     TRISBbits.TRISB4
#define _cs_high()  {LATBSET = 16;}
#define _cs_low()   {LATBCLR = 16;}

#define _rst        LATAbits.LATA4
#define TRIS_rst    TRISAbits.TRISA4
#define _rst_high() {LATASET = 16;}
#define _rst_low()  {LATACLR = 16;}
